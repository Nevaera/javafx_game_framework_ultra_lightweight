REM Author: DE3000
REM (Edited by: Nevaera)
REM This batch file compiles the game project within the provided directory structure
REM It is assumed that java/c is on your PATH variable. If not you can manually add it or edit it the line below
REM set PATH=%PATH%;<Path to your Java installation's bin directory>
